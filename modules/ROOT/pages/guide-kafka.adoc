...
For xref:spring.adoc[spring], devonfw uses link:https://spring.io/projects/spring-kafka[Spring-Kafka] as kafka framework.
For more details, check the xref:spring/guide-kafka-spring.adoc[devon4j-kafka].

For xref:quarkus.adoc[quarkus], follow https://quarkus.io/guides/kafka[Quarkus - Kafka Reference Guide].
