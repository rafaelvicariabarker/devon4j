...
The authentication via JWT needs some configuration, e.g. a keystore to verify the token signature. This is explained in the xref:../guide-jwt.adoc[JWT  documentation].
