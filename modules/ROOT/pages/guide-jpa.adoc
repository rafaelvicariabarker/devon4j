...
For xref:spring.adoc[spring] see xref:spring/guide-spring-configuration.adoc#database-configuration[here].

For xref:quarkus.adoc[quarkus] see xref:quarkus/guide-quarkus-configuration.adoc#database-configuration[here].
